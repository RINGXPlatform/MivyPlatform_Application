      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).pushNamed(APP_ROUTE_TERMS_AND_CONDITION, arguments: {"key": "kakao"});
              },
              child: Container(
                width: displayWidth,
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).pushNamed(APP_ROUTE_TERMS_AND_CONDITION, arguments: {"key": "naver"});
              },
              child: Container(
                width: displayWidth,
                padding: EdgeInsets.all(12.0),
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).pushNamed(APP_ROUTE_TERMS_AND_CONDITION, arguments: {"key": "google"});
              },
              child: Container(
                width: displayWidth,
                padding: EdgeInsets.all(12.0),
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).pushNamed(APP_ROUTE_LOGIN_SCREEN);
              },
              child: Opacity(
                opacity: 0.73,
                child: Container(
            ...
            Opacity(
              ...
              child: Container(
                  height: 2,
                  margin: EdgeInsets.symmetric(vertical: 24.0, horizontal: 38.0),
                  decoration: BoxDecoration(border: Border.all(color: const Color(0x3b3b3b3b), width: 1))),
            ),
            GestureDetector(
              onTap: () {
              ...
              child: Container(
                ...
                margin: EdgeInsets.symmetric(vertical: 0.0, horizontal: 38.0),
                decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5)), color: const Color(0xff2274f4)),
                child: textRegular("회원가입",
                    style: const TextStyle(
                        color: const Color(0xffffffff),
                        fontWeight: FontWeight.w400,
                        fontFamily: "NotoSans",
